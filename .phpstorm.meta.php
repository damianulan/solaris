    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'modules' => \Modularis\ModuleRegistry::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/solaris/public/storage' => 'string',
            ...
            'modularis.cache.enabled' => 'boolean',
            'modularis.cache.prefix' => 'string',
            'modularis.cache.store' => 'string',
            'modularis.cache.expire_after' => 'integer',
            'sentinel.default_context' => 'string',
            'sentinel.wardens.roles' => 'string',
            'sentinel.wardens.permissions' => 'string',
            'sentinel.models.role' => 'string',
            'sentinel.models.permission' => 'string',
            'sentinel.root' => 'string',
            'sentinel.cache.driver' => 'string',
            'sentinel.cache.key' => 'string',
            'sentinel.cache.expire_after' => 'integer',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/solaris/public/storage',
...
'session.same_site','session.partitioned','session.serialization','theme.colors.background','theme.colors.surface',
'theme.colors.primary','theme.colors.secondary','theme.colors.accent','theme.colors.error','theme.colors.info',
'theme.colors.success','theme.colors.warning','modularis.cache.enabled','modularis.cache.prefix','modularis.cache.store',
'modularis.cache.expire_after','sentinel.default_context','sentinel.wardens.roles','sentinel.wardens.permissions','sentinel.models.role',
'sentinel.models.permission','sentinel.root','sentinel.cache.driver','sentinel.cache.key','sentinel.cache.expire_after',
'inertia.ssr.enabled','inertia.ssr.runtime','inertia.ssr.ensure_runtime_exists','inertia.ssr.url','inertia.ssr.hot_url',
...
'inertia.devtools.gate','inertia.devtools.redact.keys','inertia.devtools.redact.headers','boost.enabled','boost.rules.enabled',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','purifier.encoding','purifier.finalize','purifier.ignoreNonStrings',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'boost.browser-logs','horizon.stats.index','horizon.workload.index',
...
'log-viewer.index','filepond-process','filepond-patch','filepond-head','filepond-revert',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','log-viewer::index','mcp::authorize',
...
'APP_URL','APP_TIMEZONE','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
...
'SESSION_DRIVER','SESSION_LIFETIME','SESSION_DOMAIN','SESSION_ENCRYPTION','SESSION_SECURE_COOKIE',
'ACTIVITY_LOGGER_ENABLED','DEBUGBAR_ENABLED','MEMCACHED_HOST','MAIL_MAILER','MAIL_HOST',
'MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS',
'MAIL_HOST_ADDRESS','MAIL_FROM_NAME','MAILCATCHALL_ENABLED','MAILCATCHALL_RECEIVER','SETTINGS_CACHE_ENABLED',
'DATEFORMAT','TIMEFORMAT','REDIS_HOST','REDIS_USERNAME','REDIS_PASSWORD',
'REDIS_PORT',);
